...
// Latched selection while transaction is in-flight                     // TODO Review Logic (skid buffer?)
...
// Latching logic
  always_ff @(posedge clk_i or posedge rst_i) begin
    if (rst_i) begin
      ...
      // Lock target when 
      if (aw_handshake && !aw_hs_seen) begin                        // TODO Should i still be using _seen flags
        aw_hs_seen <= 1'b1; 
  ...
  // Forward routing
    ...
    // Routing
      // Write channels
        ...
        // W
          if (skid_full) begin                              // TODO bypass?
